...
export const vehicleAssets: Record<string, VehicleAsset> = {
  luxury_sedan_black_001: {
    ...
    windowsDown:     `${VEHS}/overlays/vehicle_luxury_sedan_black_windows_down_v001.png`,
    occupiedPassenger: `${VEHS}/overlays/vehicle_luxury_sedan_black_passenger_v001.png`,
    damageLight:     `${VEHS}/damage/vehicle_luxury_sedan_black_damage_light_v001.png`,
    damageHeavy:     `${VEHS}/damage/vehicle_luxury_sedan_black_damage_heavy_v001.png`,
  },
};
